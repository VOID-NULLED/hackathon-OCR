...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='ocr_user'),
        'PASSWORD': config('DB_PASSWORD', default='ocr_password'),
...
# OCR Settings
OCR_MAX_FILE_SIZE = config('OCR_MAX_FILE_SIZE', default=10 * 1024 * 1024, cast=int)  # 10MB
